...
class Post_Views_Counter_List_Widget extends WP_Widget {
	...
	public function form( $instance ) {
        ...
        // @withemes
		$html = '
        <div class="fox-notice fox-error"><strong>Deprecated Widget</strong>: This widget will continue to work but you should use "<strong>(FOX) Post List</strong>" widget. It also has option for displaying most viewed posts, and much more options.</div>
	<p>
